...
export default function New({history}){
    ...
    return (
        <form onSubmit={handleSubmit}>
            ...
            <label htmlFor="techs">CATEGORIAS * <span>(Separadas por virgula)</span> </label>
            <input 
                id="techs"
                placeholder="Quais categorias que usam"
                value= {techs}
                onChange={event => setTechs(event.target.value)}
            />
            <label htmlFor="techs">VALOR NORMAL * <span>(Em branco para GRATUITO)</span> </label>
            <input 
                id="valorNormal"
